...
export function firstNotesBodyLine(body, emptyLabel = "") {
  return String(body ?? "")
    .split(/\r?\n/)
    .map((line) => line.trim())
...
export function noteMatchesQuery(note, query, locale = "en-US") {
...
export function visibleNotes(documentState, mode, query, newestFirst = true, locale = "en-US") {
