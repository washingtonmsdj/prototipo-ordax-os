...
const SOURCE = Object.freeze({
  ...
  "home.pending.notifications.action.one": "Abrir notificações — {count} não lida",
  "home.pending.notifications.action.many": "Abrir notificações — {count} não lidas",
  "home.pending.sync.title.one": "{count} alteração local pendente",
  ...
  "home.continuation.activity.unknown": "atividade desconhecida",
  "home.continuation.persistence.session": " · somente nesta sessão",
  "home.continuation.project.detail": "Projeto · {path} · {activity}{persistence}",
  "home.continuation.project.action": "Continuar projeto {name}",
  "home.continuation.recent.detail": "Arquivo recente · {folder} · {activity}{persistence}",
  "home.continuation.recent.action": "Mostrar {name} em Arquivos",
...
const ENGLISH = Object.freeze({
  ...
  "home.pending.notifications.detail.session": "history only for this session",
  "home.pending.notifications.action.one": "Open notifications — {count} unread",
  "home.pending.notifications.action.many": "Open notifications — {count} unread",
  "home.pending.sync.title.one": "{count} pending local change",
  ...
  "home.pending.sync.queue.session": "queue only for this session",
  "home.pending.sync.action": "Open Account in Sync",
  "home.continuation.heading": "Continue working",
  "home.continuation.activity.unknown": "activity unknown",
  "home.continuation.persistence.session": " · this session only",
  "home.continuation.project.detail": "Project · {path} · {activity}{persistence}",
  "home.continuation.project.action": "Continue project {name}",
  "home.continuation.recent.detail": "Recent file · {folder} · {activity}{persistence}",
  "home.continuation.recent.action": "Show {name} in Files",
