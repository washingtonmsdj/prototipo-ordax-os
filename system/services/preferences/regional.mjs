...
export const REGIONAL_LOCALE_OPTIONS = Object.freeze(
  FIRST_RUN_OFFERED_LOCALES.map((value) =>
...
export const regionalLocalePreference = choicePreference({
  ...
  title: "Idioma",
  description:
    "O MVP oferece Português (Brasil) e English. Español, Deutsch e Français permanecem aceitos para compatibilidade de estados existentes, mas não são oferecidos novamente até a Surface correspondente estar completa.",
  defaultValue: "pt-BR",
