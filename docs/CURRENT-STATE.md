...
APP_ASSISTANT_RELEASE_MODE=git-app
...
FIRST_RUN_PREVIEW_LOCALES=en-US,es-419
LOCALIZATION_CATALOG=PT-BR_COMPLETE_EN-US_ES-419_PREVIEW
...
LOCAL_AI_APP=IMPLEMENTED_OPTIONAL_CAPABILITY_GATED
LOCAL_AI_BACKEND_PROTOCOL=OPENAI_COMPATIBLE_LOOPBACK
LOCAL_AI_DEFAULT_ENGINE=LLAMA_CPP
LOCAL_AI_CREATOR_PACK=OPTIONAL_SIGNED_PACK_PENDING_PUBLICATION
LOCAL_AI_INITIAL_MODEL_TARGET=QWEN3_4B_GGUF
LOCAL_AI_PHYSICAL_PROOF=PENDING
```
