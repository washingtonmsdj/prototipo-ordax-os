...
PUBLIC_IDENTITY_EDGE_GATEWAY=DEPLOYED_ORDAX_CONTROL_PLANE_SOURCE_V8_RECOVERY_TOKEN_HASH_GATED
PUBLIC_IDENTITY_EDGE_DEPLOYMENT_REVISION=11_SOURCE_EXACT_MATCH
