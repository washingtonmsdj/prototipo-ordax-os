...
English is **not** yet marked as a complete Surface locale. **Files is complete in
English at source level**, including operational/error messages and its Files→Notes
action, with a CI regression that rejects Portuguese UI copy outside the shared
catalog. Settings/System cover their section navigation/header copy. Account,
Notes, Internet, deeper Settings/System content and quick-panel copy still require
migration. Spanish, German and French remain OOBE-complete but
Surface-incomplete.
