...
PUBLIC_IDENTITY_EDGE_GATEWAY=DEPLOYED_ORDAX_CONTROL_PLANE_SOURCE_V6_REGISTRATION_PASSWORD_POLICY
PUBLIC_IDENTITY_EDGE_DEPLOYMENT_REVISION=7_SOURCE_EXACT_MATCH
