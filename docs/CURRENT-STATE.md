...
PUBLIC_IDENTITY_EDGE_GATEWAY=DEPLOYED_ORDAX_CONTROL_PLANE_SOURCE_V9_RECOVERY_TOKEN_HASH_GATED
PUBLIC_IDENTITY_EDGE_DEPLOYMENT_REVISION=12_SOURCE_EXACT_MATCH
