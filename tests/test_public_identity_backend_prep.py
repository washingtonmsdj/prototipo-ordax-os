...
class PublicIdentityBackendPrepTests(unittest.TestCase):
    def test_identity_contract_selects_dedicated_target_without_enabling_public_auth(self):
        ...
        self.assertEqual(
            contract["status"],
            "provider-adapter-source-v8-edge-revision-10-recovery-token-hash-gated-public-server-gated",
        )
        ...
        self.assertEqual(contract["backend"]["edge_deployment_revision_observed"], 10)
