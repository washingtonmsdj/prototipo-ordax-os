...
class SystemRuntimeStatusTests(unittest.TestCase):
    ...
    def test_shared_system_overview_uses_only_neutral_ports(self):
        ...
        self.assertIn('t("system.updates.history.title")', controls)
        self.assertIn('t("system.about.delivery.kicker")', controls)
        self.assertIn('"system.updates.component.release.bundled"', controls)
        self.assertIn('"system.updates.component.release.componentSlot"', controls)
        self.assertIn('"system.updates.component.detail.bundled"', controls)
        self.assertIn('t("system.about.delivery.policy")', controls)
        ...
        self.assertIn("baseUpdatePhaseMessageId", controls)
