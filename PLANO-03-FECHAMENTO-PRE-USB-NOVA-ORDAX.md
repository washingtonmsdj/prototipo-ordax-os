...
5. Cobertura real de idioma da Surface para os idiomas oferecidos no OOBE. — **IN_PROGRESS**: owner compartilhado e shell inglês `PASS_SOURCE`; controles dos apps ainda em migração
